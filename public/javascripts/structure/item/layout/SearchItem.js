...
export function Item(_ref) {
	...
	return React.createElement(
		...
		React.createElement("div", { className: "showItems__item__img-border" }),
		React.createElement("img", { className: "showItems__item__img", src: "/images/eating-small/" + ID + "-small.jpg" }),
		React.createElement(
			"a",
			{ className: "showItems__item__linkTo", href: '/items/show/' + slug },
...
function ItemRating(_ref2) {
	...
	return React.createElement(
		...
		React.createElement(
			"div",
			{ className: "showItems__item__rating-triangle", style: myStyle },
			React.createElement(
				"div",
...
function EditItemButton(_ref4) {
	...
	return React.createElement(
		"a",
		{ href: "/items/edit/" + slug, className: "showItems__item__button__edit" },
		React.createElement(
			"svg",
...
function DeleteItemButton(_ref5) {
	...
	return React.createElement(
		"form",
		{ className: "showItems__item__button__delete", action: "/items/delete/" + slug, method: "post", id: "deleteItem-" + slug, onClick: deleteElement },
		React.createElement(
			"svg",
