...
export function Item({props}) {
	...
	return (
		<div className="showItems__item">
			...
			<div className="showItems__item__img-border"></div>
...
function EditItemButton({slug}) {
	return (
		<a href={"/items/edit/" + slug} className="showItems__item__button__edit" >
...
function DeleteItemButton({slug}) {
	...
	return (
		<form className="showItems__item__button__delete" action={"/items/delete/" + slug} method="post" id={"deleteItem-" + slug} onClick={deleteElement} >
